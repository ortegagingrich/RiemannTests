...
#let's try something
import sys
sys.path.insert(0,'/home/jog/Software_Development/uw/Riemann/hybrid/src/python')
...
def setplot(plotdata):
    ...
    plotitem.plot_var = geoplot.surface_full1
    plotitem.plot_var2 = geoplot.topo
    plotitem.color = 'b'
    
    #plot where there the corrector wave is large
    plotitem=plotaxes.new_plotitem(plot_type='1d_fill_between')
    plotitem.plot_var=geoplot.surface_corrector1
    plotitem.plot_var2=geoplot.topo
    plotitem.color='y'
    ...
    plotaxes.xlimits=xlims
    plotaxes.ylimits=ylims
    plotaxes.title='hybrid solver'
    
    #plot where the roe solver is being used
    plotitem=plotaxes.new_plotitem(plot_type='1d_fill_between')
    plotitem.plot_var=geoplot.surface_roe2
    plotitem.plot_var2=geoplot.topo
    plotitem.color='m'
    
    #plot where the full solver is being used
    plotitem=plotaxes.new_plotitem(plot_type='1d_fill_between')
    plotitem.plot_var=geoplot.surface_full2
    plotitem.plot_var2=geoplot.topo
    plotitem.color='b'
