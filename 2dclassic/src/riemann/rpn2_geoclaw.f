...
c         do i=2-mbc,mx+mbc
c          if (ixy.eq.1) then
c             dxdc=(earth_radius*deg2rad)
c          else
c             dxdc=earth_radius*cos(auxl(3,i))*deg2rad
c          endif
c
c          do mw=1,mwaves
...
c                endif
c	           s(mw,i)=dxdc*s(mw,i)
c               fwave(1,mw,i)=dxdc*fwave(1,mw,i)
c               fwave(2,mw,i)=dxdc*fwave(2,mw,i)
c               fwave(3,mw,i)=dxdc*fwave(3,mw,i)
c          enddo
c         enddo
c        endif
c
