...
#------------------------------
    ...
    probdata.add_param('g',     9.81,  'gravitational acceleration')
    probdata.add_param('drytol',  1.e-3,'dryness tolerance')
    ...
    clawdata.lower[0] = -1.000000e+02          # xlower
    clawdata.upper[0] = 1.000000e+02          # xupper
    clawdata.lower[1] = -1.000000e+02          # ylower
    clawdata.upper[1] = 1.000000e+02          # yupper
