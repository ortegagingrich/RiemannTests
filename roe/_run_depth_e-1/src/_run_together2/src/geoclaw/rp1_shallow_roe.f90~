! =========================================================
subroutine roe(maxmx,meqn,mwaves,maux,mbc,mx,ql,qr,auxl,auxr,fwave,s,amdq,apdq)
! =========================================================
...
!     # Main loop of the Riemann solver.
    ...
    !     # Finally, compute the waves.
    	s(1,i) = ubar - cbar
        fwave(1,1,i) = s(1,i)*a1
        fwave(2,1,i) = s(1,i)*a1*(ubar - cbar)
        
        s(2,i) = ubar + cbar
        fwave(1,2,i) = s(2,i)*a2
        fwave(2,2,i) = s(2,i)*a2*(ubar + cbar)
