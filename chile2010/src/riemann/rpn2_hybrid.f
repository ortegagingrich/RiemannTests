...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      !local: mod
      double precision :: deeptol,jumptol
      
      !deeptol=1.d3 and jumptol=1.d99 
      deeptol=1.d3!1.d3
      jumptol=1.d99!1.d-4
...
!-----------------------Initializing-----------------------------------
         ...
         if((hL.ge.deeptol.and.hR.ge.deeptol) 
     &    .and.(abs(hL-hR).lt.(jumptol*(hL+hR)))) then
         	!record this as a roe solve
         	!roesolves=roesolves+1
         	
         	!call the steady state roe solver
         	call shallow_roe_jog(hL,hR,huL,huR,hvL,hvR,bL,bR,sw,fw)
         	
         	!copy results into wave speed and fwave arrays
         	do mw=1,3
         		s(mw,i)=sw(mw)
         	...
         	!record this as a full solve
         	!fullsolves=fullsolves+1
         endif
